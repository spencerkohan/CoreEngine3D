...
#define g_Fullscreen_Model_numberOfVertices	4
#define g_Fullscreen_Model_numberOfPrimitives 1
...
ModelData g_Fullscreen_Model_modelData = {VertexFormat_VNT,"Square_TopHalf",g_Fullscreen_Model_PrimitiveArray,g_Fullscreen_Model_numberOfPrimitives,-1};
