...
const u32 RenderFlagDefaults_CardWithAlpha_DepthWrite = RenderFlag_DisableCulling|RenderFlag_AlphaBlended|RenderFlag_NonPremultipliedAlpha|RenderFlag_EnableDepthTest|RenderFlag_EnableDepthWrite;
